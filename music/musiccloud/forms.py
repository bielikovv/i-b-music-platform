...
class AddAlbumForm(forms.ModelForm):
    ...
    album_user = forms.ModelChoiceField(label='', empty_label=None, disabled=True, queryset=User.objects.all(), widget=forms.HiddenInput(attrs={'class': 'form-control form-control-sm'}))
